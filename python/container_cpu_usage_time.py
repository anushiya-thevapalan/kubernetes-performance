import json
import objectpath
def get_container_cpu_usage(filename):
    with open(filename) as datafile:
        data = json.load(datafile)

    file = open("container_cpu_usage_time.csv", "w+")
    ...
    file.close()
#Testing purpose
# filename = "/home/anushiyat/Documents/wso2/project/server-architecture-performance/bash/container_cpu_usage_time.json"
# get_container_cpu_usage(filename)